...
choosePort(HOST, DEFAULT_CLIENT_PORT)
  .then(port => {
    ...
    // VIDEO_FIT_CLIENT_PORT won't be set at new webpack.DefinePlugin(env.stringified)
    process.env.VIDEO_FIT_CLIENT_PORT = port
    ...
    clientServer.listen(port, HOST, err => {
      ...
      choosePort(HOST, DEFAULT_SERVER_PORT)
        .then(portServer => {
          ...
          process.env.VIDEO_FIT_SERVER_PORT = portServer;
